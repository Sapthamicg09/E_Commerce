...
import com.Sapthami.SpringBoot.E_Commerce.respository.ProductImageRepository;
import com.Sapthami.SpringBoot.E_Commerce.respository.ProductRepository;
...
{ 
	...
	{ 
		Product product = productRepository.findById(item.getProductId()).orElse(null); if (product == null) 
		{ 
